# Este código sólo obtiene las URL de 47 tesis de arquología
# de 1946 a 2022
# Consulta a la B. G. Bonfil Batalla de la ENAH con la clasficacion X7 doctorado
# Usa un XLSX con el listado de 3 consultas y extraer las URL de 47 tesis
# 
# El resultado se usa para luego extraer toda la metadata de cada 47 
# de las tesis de doctorado en arqueologia
...
setwd("D:/_2014-2022/2023/Redes_tesis/dr_arq_x7b")

# Leer las urls desde el archivo xlsx
url <- readxl::read_excel("D:/_2014-2022/2023/Redes_tesis/dr_arq_x7b/url20tesisxhoja.xlsx")
...
for(i in 1:length(url$url)){
  ...
  # tiempo de espera varable de entre 1 y 5 segundos, es lento, pero 
  # evita que el servidor te rechace
  wait_time <- runif(1, 1, 5)
  Sys.sleep(wait_time)
...
# Guardar en excel
rio::export(ref_tb_viewrec,"ref_tb_viewrec.xlsx")

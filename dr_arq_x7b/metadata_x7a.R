# Este código obtiene toda la metadata de las 47 tesis de arquología
# de 1946 a 2022
# Consulta la B. G. Bonfil Batalla de la ENAH con la clasficacion X7 doctorado
# Usa un XLSX con el listado de 47 consutlas y
# extraer la metadata en de las 47 tesis en un archivo de XLSX
# 
...
url <- readxl::read_excel("D:/_2014-2022/2023/Redes_tesis//dr_arq_x7b/url_ref_tb_viewrec.xlsx")
...
# 
# exportar a un archivo XLS las tesis X7 de dr. Arqueología
rio::export(tesis_tibble,"todas_las_tesis_x7b.xlsx")

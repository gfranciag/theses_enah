# Este código obtiene toda la metadata de las 1188 tesis de arquología
# de 1946 a 2022
# Consulta la B. G. Bonfil Batalla de la ENAH con la clasficacion X7 licenciatura
# Usa un XLSX con el listado de 1188 consutlas y
# extraer la metadata en de las 1188 tesis en un archivo de XLSX
# 22:32 22:40
...
url <- readxl::read_excel("D:/_2014-2022/2023/Redes_tesis/url_ref_tb_viewrec.xlsx")
...
rio::export(tesis_tibble,"todas_las_tesis_x7.xlsx")
